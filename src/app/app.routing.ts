...
export const appRoutes: Route[] = [
    ...
    {path: '', pathMatch : 'full', redirectTo: 'apps/Dashboard/dashboard-page'},
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'apps/Dashboard/dashboard-page'},
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            //     {path: 'dashboard', data: {
            //         breadCrum:'Dashboard'
            //     }, loadChildren: () => import('app/modules/admin/dashboards/dashboard/dashboard.module').then(m => m.DashboardModule)},
            ...
            data: {
             ...
             children: [
                {path: 'Dashboard', data: {
                    breadCrum:'Dashboard'
                }, loadChildren: () => import('app/modules/admin/apps/Dashboard/dashboard.module').then(m => m.DashboardModule)},
                {path: 'users', data: {
                    breadCrum:'User'
                }, loadChildren: () => import('app/modules/admin/apps/users/users.module').then(m => m.UsersModule)},
              {path: 'Customers', data: {
                    breadCrum:'Customer'
                ...
                {path: 'Articles', data: {
                    breadCrum:'Articles'
                }, loadChildren: () => import('app/modules/admin/apps/Article/article.module').then(m => m.ArticleModule)},
                 {path: 'Gallery', data: {
                    breadCrum:'Gallery'
                }, loadChildren: () => import('app/modules/admin/apps/Gallery/gallery.module').then(m => m.GalleryModule)},
            ...
            {path: 'Survey', loadChildren: () => import('app/modules/admin/apps/Survey/survey.module').then(m => m.SurveyModule)},
            ]},
